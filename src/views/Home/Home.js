...
const Home = () => {
  ...
  return (
    ...
    <Grid item  xs={12} sm={12} justify="center"  style={{ margin: '12px', display: 'flex' }}>
            ...
            {/* Vinyl Finance has not launched! But will very soon. Final contracts are deployed and token contracts are <StyledLink target="_blank" href="https://vinyl-finance.github.io/vinylfinance-docs/docs/welcome/protocol-info/contracts">renounced</StyledLink>. <p>Follow us on <StyledLink target="_blank" href="https://twitter.com/vinyl_finance">Twitter</StyledLink> and join our <StyledLink target="_blank" href="https://discord.gg/VqwsjEFVzc">Discord</StyledLink> for launch updates.</p> */}
              {/* <b> */}
      ...
      {/* Please visit our <StyledLink target="_blank" href="https://vinyl-finance.github.io/vinylfinance-docs/docs/welcome">documentation</StyledLink> before purchasing VINYL or TRACKS! */}
      {/* </b> */}
            {/* </Alert> */}
        </Grid>
        </Grid>
        ...
        <Grid item xs={12} sm={8}>
          <Card style={{ height: '100%' }}>
            <CardContent align="center" style={{ marginTop: '2.5%' }}>
              ...
              <Button color="primary" href={tombChartUrl} target="_blank" variant="contained" className={classes.button} style={{ marginRight: '10px' }}>
                VINYL Chart
              </Button>
              <Button color="primary" href={tshareChartUrl} target="_blank" variant="contained" className={classes.button}>
                TRACKS Chart
              </Button>
            </CardContent>
          </Card>
