...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(tombFinance.TRACKS, tombFinance.contracts.Masonry.address);

  const tokenBalance = useTokenBalance(tombFinance.TRACKS);
  const stakedBalance = useStakedBalanceOnMasonry();
  const { from, to } = useUnstakeTimerMasonry();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('TRACKS', tombFinance.TRACKS);
      ...
      <Card>
        <CardContent>
          <StyledCardContentInner>
            <StyledCardHeader>
              <CardIcon>
                <TokenSymbol symbol="TRACKS" />
              </CardIcon>
              <Value value={getDisplayBalance(stakedBalance)} />
              <Label text={`≈ $${tokenPriceInDollars}`} />
              <Label text={'TRACKS Staked'} />
            </StyledCardHeader>
            <StyledCardActions>
